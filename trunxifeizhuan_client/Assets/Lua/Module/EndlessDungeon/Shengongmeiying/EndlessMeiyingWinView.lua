...
local mEndlessMeirenWinView = require "Module/EndlessDungeon/Meirenxinji/EndlessMeirenWinView"
local mGameModelManager = require "Manager/GameModelManager"
local mUIManager = require "Manager/UIManager"
local mViewEnum = require "Enum/ViewEnum"
local mEndlessDungeonController = require "Module/EndlessDungeon/EndlessDungeonController"
local EndlessMeiyingWinView = mLuaClass("EndlessMeiyingWinView",mEndlessMeirenWinView);


function EndlessMeiyingWinView:OnClickClose()
