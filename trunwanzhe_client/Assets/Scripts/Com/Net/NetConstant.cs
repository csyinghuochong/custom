...
namespace Assets.Scripts.Com.Net
{
    ...
    {
        public static readonly int cPackageHead_Len_Size = sizeof(short);//<<Len:16, Cmd:16,Crc:32,Seq:32>>
        public static readonly int cPakcageHead_CMD_CRC_SEQ_Size = sizeof(short) + sizeof(int) + sizeof(int);//<<Len:16, Cmd:16,Crc:32,Seq:32>>
        public static readonly int cPackageHeadSize = cPackageHead_Len_Size + cPakcageHead_CMD_CRC_SEQ_Size;//<<Len:16, Cmd:16,Crc:32,Seq:32>>
