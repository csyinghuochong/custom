...
function StringUtil:SecondsToDHM(second)
    local d = second / (3600 * 24);
    local h = (second % (3600 * 24)) / 3600;
    local m = (second % 3600) / 60;
    return mString.format("%d天%d小时%d分", d, h, m);
end

function StringUtil:Random(n, m)
    --随机结果放大后再置随机种子，然后随机--
    mMath.randomseed(os.clock() * mMath.random(1000000, 90000000) * mMath.random(1000000, 90000000));
