...
/// 添加传送门节点
/// </summary>
public class PortalNode : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (RootTrans != null)
            EditorGUILayout.LabelField("添加的传送门id: " + RootTrans.name.Substring(7));
        ...
        targetRotation = EditorGUILayout.FloatField("目标位置方向: ", targetRotation);
        if (GUILayout.Button("复制选中位置和方向"))
        {
            if (Selection.activeTransform == null)
            {
            ...
            else
            {
                ...
                targetRotation = Selection.activeTransform.eulerAngles.y;
            }
        }
        ...
        //EditorGUILayout.LabelField("目标点类型: (0传送点，1指引点）");
        //targetType = EditorGUILayout.IntField("目标点类型: ", targetType);
    ...
    private void AddNode()
    {
        ...
        vo.id = int.Parse(RootTrans.name.Substring(7));
        vo.type = addType;
        vo.flag = addFlag;
        vo.close = addClose;
        vo.name = addName;
