...
namespace Assets.Editor.Depend
{
    class DependBase
    {
        ...
        public string GetAssetsListStr()
        {
            ...
            if (GetAssetsListCount() == 0)
            {
                return result + "nil";
            }

            for (int i = 0, count = GetAssetsListCount(); i < count; i++)
            {
    ...
    class MeshFilterDepend : DependBase
    {
        MeshFilter mMeshFilter;

        public MeshFilterDepend()
        {
            mExtension = ".prefab";
            mAssetType = AssetType.MeshFilter;
        }
        ...
        public override List<string> CompareComponent(Component component)
        {
            ...
            if (componentTypeName == GetTypeName())
            {
                mMeshFilter = component as MeshFilter;

                return DependCollectTool.AnalyseMeshFilter(mMeshFilter);
            }
    ...
    class MeshRendererDepend : DependBase
    {
        ...
        public override List<string> CompareComponent(Component component)
        {
            ...
            if (componentTypeName == GetTypeName())
            {
                ...
                return DependCollectTool.AnalyseRenderer(render);
            }
    ...
    class SkinnedMeshRendererDepend : MeshRendererDepend
    {
        public SkinnedMeshRendererDepend()
        {
            mExtension = ".mat";
            mAssetType = AssetType.SkinnedMeshRenderer;
        }
    }
}
