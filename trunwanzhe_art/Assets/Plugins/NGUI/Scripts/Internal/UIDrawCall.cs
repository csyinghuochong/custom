...
public class UIDrawCall : MonoBehaviour
{
	...
	void OnWillRenderObject ()
	{
		...
		if (mTextureClip)
		{
            ...
            mDynamicMat.SetVector(ClipRange[1], new Vector4(-cr.x / cr.z, -cr.y / cr.w, 1f / cr.z, 1f / cr.w));
            mDynamicMat.SetTexture("_ClipTex", clipTexture);

            //////////////////////////////////////////////////////////////////////////
            float angle = 0f;

            Vector3 pos = panel.cachedTransform.InverseTransformPoint(panel.cachedTransform.position);
            cr.x -= pos.x;
            cr.y -= pos.y;

            Vector3 v0 = panel.cachedTransform.rotation.eulerAngles;
            Vector3 v1 = panel.cachedTransform.rotation.eulerAngles;
            Vector3 diff = v1 - v0;
            ...
            SetClipping(0, cr, panel.clipSoftness, angle);
